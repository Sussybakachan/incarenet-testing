...
public class CRTRow {
    ...
    static boolean isCrtParameterSelected() {
        boolean crtParameterIsChecked = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[2]/table/tbody/tr[2]/td[1]/span/span[1]/input")).isSelected();
        return crtParameterIsChecked;
    }
