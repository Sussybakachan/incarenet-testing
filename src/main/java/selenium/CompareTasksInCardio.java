...
import static ExpectedTasks.MicroPortExpectedTasks.microPortExpectedList;
...
//ist wichtig
    ...
    static void compareCrt(List<Task> listname) throws InterruptedException {
        ...
        for (int i = 0; i < collectedTasks.size(); i++) {
            for(int j = 0; j < listname.size(); j++){
                ...
                if (listname.get(j).equals(collectedTasks.get(i))) {
    ...
    public static String patientnamexd() {
        return "Sel-MicroPort";
    }
