...
public class BostonExpectedTasksTestCase12 {
    public static List<Task> BostonTestCase12List = new ArrayList<>();
    ...
    public BostonExpectedTasksTestCase12() {
        createBostonYellowLv70AlarmTask();
    ...
    public static List<Task> createBostonYellowLV85AlarmTask() {
        ...
        BostonTestCase12List.add(BostonLv85AlarmTask);
        return BostonTestCase12List;
    }


    public static List<Task> createBostonYellowLv70AlarmTask() {
        ...
        BostonTestCase12List.add(BostonLv70AlarmTask);
        return BostonTestCase12List;
    }
    ...
    public static List<Task> createBostonEriAlarmTask() {
        ...
        BostonTestCase12List.add(BostonEriAlarmTask);
        return BostonTestCase12List;
    }
    ...
    public static List<Task> createBostonEosAlarmTask() {
        ...
        BostonTestCase12List.add(BostonEosAlarmTask);
        return BostonTestCase12List;
    }
