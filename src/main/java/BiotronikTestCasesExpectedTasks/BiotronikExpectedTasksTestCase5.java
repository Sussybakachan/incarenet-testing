...
public class BiotronikExpectedTasksTestCase5 {

    public static List<Task> BiotronikTestCase5List = new ArrayList<>();
    ...
    public BiotronikExpectedTasksTestCase5() {
        createBiotronik93generalTaskCase5();
        createBiotronikEOSAlarmTask();
        createBiotronikERIAlarmTask();
        createBiotronik97generalTaskCase5();
    }

    public static List<Task> createBiotronik97generalTaskCase5() {
        ...
        BiotronikTestCase5List.add(Biotronik97LVAlarmTask);
        return BiotronikTestCase5List;
    }
    ...
    public static List<Task> createBiotronikERIAlarmTask() {
        ...
        BiotronikTestCase5List.add(BiotronikERIAlarmTask);
        return BiotronikTestCase5List;
    }
    ...
    public static List<Task> createBiotronikEOSAlarmTask() {
        ...
        BiotronikTestCase5List.add(BiotronikEOSAlarmTask);
        return BiotronikTestCase5List;
    }
    ...
    public static List<Task> createBiotronik93generalTaskCase5() {
        ...
        BiotronikTestCase5List.add(Biotronik93AlarmTask);
        return BiotronikTestCase5List;
    }
}
